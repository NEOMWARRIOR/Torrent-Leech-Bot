...
class Config(object):
    ...
    TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "5163456283:AAFa-ImdwUMrDnNcIC182PuiEgLvTSs_xC8")
    # The Telegram API things
    APP_ID = int(os.environ.get("APP_ID", 2036491))
    API_HASH = os.environ.get("56c5598caa3b1f330ff3596028985c89")
    OWNER_ID = int(os.environ.get("OWNER_ID", 5076614373))
    # Get these values from my.telegram.org
    # to store the channel ID who are authorized to use the bot
    AUTH_CHANNEL = set(int(x) for x in os.environ.get("AUTH_CHANNEL", "-1001331033066").split())
